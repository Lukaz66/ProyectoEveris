...
/** Proyecto: Clase para consumir los servicios e implementar métodos de IFamilyMemberService.
...
public class FamilyMemberController {
   ...
   /**
	* La anotación Autowired para la inyección de dependencia de IFamilyMemberService.
	*/
	@Autowired
